...
export async function initializeClients(
    ...
    if (character.plugins?.length > 0) {
        ...
        elizaLogger.debug("character.plugins", character.plugins);
...
async function startAgent(
    ...
    try {
        ...
        elizaLogger.debug("initializeDatabase", dataDir);
        ...
        elizaLogger.log("** initializeCache **");
        ...
        elizaLogger.log("** initializeClients **");

        // add to container
        directClient.registerAgent(runtime);

        elizaLogger.log("**registerAgent **");
